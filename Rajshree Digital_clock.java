...
public class Digital_clock extends JFrame {
    ...
    public Digital_clock() {
        ...
        // we have to create a panel to hold the time and date labels
        JPanel panel = new JPanel();
        panel.setBorder(BorderFactory.createEmptyBorder(20, 20, 20, 20));
        panel.setLayout(new BorderLayout());

        // Now we create a label to display the time
        ...
        // Now also create  a label to display the date
        ...
        // Afterthat we add the time and date labels to the panel
        panel.add(timeLabel, BorderLayout.CENTER);
        panel.add(dateLabel, BorderLayout.SOUTH);

        //in next step we Set the panel's background color
        panel.setBackground(Color.BLACK);

        // now we Add the panel to the frame
        add(panel);
